    ...
    return (
      <React.Fragment>
        <div
          ...
          style={{
            backgroundImage: "url(https://plus.unsplash.com/premium_photo-1661306437817-8ab34be91e0c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)",
          }}
        >
              ...
              <div className="row">
                <div className="col-7">
                  {/* <span className="align-middle fw-bold">
                    {this.state.totalItems} Resu for{" "}
